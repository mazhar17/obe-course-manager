# OBE Course Manager — v1.50 (First release: July 13, 2026)
...
See `change_log_v1.50.txt` for the version history (the log file is renamed with each release). All multi-line entry boxes throughout the app open at five rows and grow automatically with the text.
