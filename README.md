# OBE Course Manager — v1.30 (First release: July 13, 2026)
...
See `change_log_v1.30.txt` for the version history (the log file is renamed with each release).
